    ...
    <ul className="space-y-2 mr-3">
      <li className="flex items-center p-2 hover:bg-gray-100 rounded cursor-pointer ml-1">
        <Link href={`/dashboard`} passHref>
          ...
          <span
            className={`mr-2 ${
              pathName === "dashboard" ? "text-[#00BFFF]" : "text-gray-400"
            }`}
          >
            {(t("dashboard"))}
          </span>
        ...
        <Link href={`/categories`} passHref>
          ...
          <span
            className={`mr-[1.70rem] ${
              pathName === "/categories" ? "text-[#00BFFF]" : "text-gray-400"
            }`}
          >
            {(t("categories"))}
          </span>
      ...
      <li className="flex items-center p-2 hover:bg-gray-100 rounded cursor-pointer ml-1">
        <Link href="/bookings" passHref>
          ...
          <span
            className={`ml-1 ${
              pathName === "/bookings" ? "text-[#00BFFF]" : "text-gray-400"
            }`}
          >
            {(t("bookings"))}
          </span>
      ...
      <li className="flex items-center p-2 hover:bg-gray-100 rounded cursor-pointer ml-1">
        <Link href="/services" passHref>
          ...
          <span
            className={`ml-[0.7px] ${
              pathName === "/services" ? "text-[#00BFFF]" : "text-gray-400"
            }`}
          >
            {(t("services"))}
          </span>

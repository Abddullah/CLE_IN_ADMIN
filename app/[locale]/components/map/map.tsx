...
//         // Update the testMarker if it exists, else create one and add it to the map
//         if (testMarker) {
//           testMarker.setLngLat([newLocation.lng, newLocation.lat]); // Update the position of the existing test marker
//         } else {
//           const newTestMarker = new mapboxgl.Marker({ color: "red" })
//             .setLngLat([newLocation.lng, newLocation.lat])
//             .addTo(testMap);
//           setTestMarker(newTestMarker); // Set the test marker in the state
//         }
//       }

...
const CleaningCards: React.FC<Props> = ({
  ...
  return (
    <div
    className="relative w-[250px] rounded-3xl border-2 top-9 border-[#00BFFF] bg-white/90 backdrop-blur-sm p-6 hover:shadow-2xl transition-all duration-300 h-[450px]" // Set a fixed height
    ...
    <div className="flex flex-col items-center h-full justify-between">
      <div className="relative group">
        ...
        <div className="relative border-2 border-[#00BFFF] rounded-full overflow-hidden w-32 h-32 bg-white">
          {image && image !== "" ? (
            <Image
              src={'/assets/categoriesIcons/Factory.svg'} // image from temporary use otherwise fetch from firebase
